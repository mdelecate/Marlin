...
//
#define NUM_Z_STEPPER_DRIVERS 2   // (1-4) Z options change based on how many //keenmetal updated for Sidewinder X1
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g. 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 32 // keenmetal changed from 16 because SD,LCD,Buttons take more memory, block buffer needs to be smaller
#else
  #define BLOCK_BUFFER_SIZE 32 // keenmetal changed from 16 to maximize block buffer
#endif
